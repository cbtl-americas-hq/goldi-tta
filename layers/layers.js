...
lyr_OpenStreetMap_0.setVisible(true);lyr_GoldiTerritory_1.setVisible(true);lyr_CountyBoundary_2.setVisible(true);lyr_Sites_3.setVisible(true);lyr_TargetTradeArea_4.setVisible(true);
var layersList = [lyr_OpenStreetMap_0,lyr_GoldiTerritory_1,lyr_CountyBoundary_2,lyr_Sites_3,lyr_TargetTradeArea_4];
